    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          '---',
          { opcode: 'body_setCameraFlip', blockType: Scratch.BlockType.COMMAND, text: '体のカメラの反転を[STATE]にする', arguments: { STATE: { type: Scratch.ArgumentType.STRING, menu: 'FLIP_STATE_MENU', defaultValue: 'true' } } },
          { opcode: 'body_isCameraFlipped', blockType: Scratch.BlockType.BOOLEAN, text: '体のカメラの反転' },
          '---',
          { opcode: 'body_setPredictionRate', blockType: Scratch.BlockType.COMMAND, text: '体のトラッキングの処理レートを[RATE]にする', arguments: { RATE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 30 } } },
          { opcode: 'body_getPredictionRate', blockType: Scratch.BlockType.REPORTER, text: '体の処理のレート' },
          { opcode: 'body_setTrackingPrecision', blockType: Scratch.BlockType.COMMAND, text: '体のトラッキングの精度を[PRECISION]にする', arguments: { PRECISION: { type: Scratch.ArgumentType.STRING, menu: 'PRECISION_MENU', defaultValue: '2' } } },
          { opcode: 'body_getTrackingPrecision', blockType: Scratch.BlockType.REPORTER, text: '体のトラッキング精度' },
          '---',
          ...
          '---',
          { opcode: 'hand_setCameraFlip', blockType: Scratch.BlockType.COMMAND, text: '手のカメラの反転を[STATE]にする', arguments: { STATE: { type: Scratch.ArgumentType.STRING, menu: 'FLIP_STATE_MENU', defaultValue: 'true' } } },
          { opcode: 'hand_isCameraFlipped', blockType: Scratch.BlockType.BOOLEAN, text: '手のカメラの反転' },
          '---',
          { opcode: 'hand_setPredictionRate', blockType: Scratch.BlockType.COMMAND, text: '手のトラッキングの処理レートを[RATE]にする', arguments: { RATE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 30 } } },
          { opcode: 'hand_getPredictionRate', blockType: Scratch.BlockType.REPORTER, text: '手の処理のレート' },
          { opcode: 'hand_setTrackingPrecision', blockType: Scratch.BlockType.COMMAND, text: '手のトラッキングの精度を[PRECISION]にする', arguments: { PRECISION: { type: Scratch.ArgumentType.STRING, menu: 'PRECISION_MENU', defaultValue: '2' } } },
          { opcode: 'hand_getTrackingPrecision', blockType: Scratch.BlockType.REPORTER, text: '手のトラッキング精度' },
          '---',
